 ...
 */ function getErrorCodes(err, visited = new Set(), depth = 0) {
    ...
    if (err.name !== undefined && TIMEOUT_NAMES_AND_CODES.has(err.name) || err.code !== undefined && TIMEOUT_NAMES_AND_CODES.has(err.code) || err.type !== undefined && TIMEOUT_TYPES.has(err.type)) {
        return [
            'ETIMEDOUT'
        ];
    }
...
const transcoding_1 = __turbopack_context__.r("[project]/node_modules/googleapis-common/build/src/transcoding.js [app-route] (ecmascript)");
...
"[project]/node_modules/googleapis-common/build/src/transcoding.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ function validateAndEncodeParams(urlTemplate, // eslint-disable-next-line @typescript-eslint/no-explicit-any
params) {
...
//# sourceMappingURL=node_modules_1jx0f-j._.js.map